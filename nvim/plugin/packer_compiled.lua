...
_G.packer_plugins = {
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  ["nvim-treesitter-textobjects"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/adam/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-textobjects",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/vim-sleuth",
